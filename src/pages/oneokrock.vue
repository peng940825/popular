<template>
  <div style="background-color: #171717">
    ...
    <div class="container">
      <div class="row">
        <div
          class="col-4 col-md-4 col-lg-2 album-style"
        ...
        <div class="col mb-5">
          <div class="table-responsive">
            <table class="table table-borderless mt-5" v-if="check">
              ...
              <tbody>
                <tr v-for="(item, index) in oneokrock_songs" :key="index">
...
export default {
  ...
  methods: {
    ...
    chechAlbum(y) {
      ...
      vm.check = false;
      vm.single_album = [];
      vm.oneokrock_songs.forEach((item, index) => {
        if (item.title === y) {
